		...
		<div class="login-form">
            ...
            <form action="{{URL::to('sendsms')}}" method="post">
                <div class="form-group">
                    <input type="number" class="form-control" name="KTP" id="" placeholder="No KTP (14 digit)">
                </div>
                <div class="form-group">
                    <input type="number" class="form-control" name="telp" id="hp" placeholder="Nomor HP (Ex. 085736590630)">
                </div>
